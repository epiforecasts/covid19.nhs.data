...
readr::read_csv("https://raw.githubusercontent.com/epiforecasts/covid19.nhs.data/main/data-raw/raw/england_trusts/trust_list.csv") %>%
  dplyr::select(`Trust code` = trust_code_old, `New Trust code` = trust_code_new, `Merger date` = from_date) %>%
  knitr::kable()
