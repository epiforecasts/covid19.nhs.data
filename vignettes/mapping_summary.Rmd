...
* Trust-UTLA mapping: `covid19.england.hospitalisations::trust_utla_mapping`
* Trust-LTLA mapping: `covid19.england.hospitalisations::trust_ltla_mapping`
...
The mapping is provided as a built in package dataset and can be loaded directly using `covid19.england.hospitalisations::trust_utla_mapping` and `covid19.england.hospitalisations::trust_ltla_mapping` or as shown below.
