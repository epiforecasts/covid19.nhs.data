...
* `geo_code`: the nine-digit identifier for upper-tier local authorities in England.
* `p_trust`: the proportion of admissions to a given Trust were admitted from a given UTLA
* `p_geo`: the proportion of admissions from a given UTLA that were admitted to a given Trust.
