...
dplyr::filter(from_date < Sys.Date())
...
```{r make_trust-ltla_raw_mapping}
# Create clean LTLA-Trust counts (get Trust ID, add Trust mergers)
...
```{r make_trust-utla_mapping}
##### Create UTLA-Trust mapping #####
...
# Output final LTLA-Trust mapping
...
# Add public mappings to R package
