...
```{r summarise_mapping, echo = TRUE, eval = TRUE}
...
Please note that this visualisation will not reflect Trust-LTLA pairs where `source == "hospital_postcode"` or `source == "utla_final_match"`.
